...
class Hospital:
    def __init__(self, root):
        ...
        self.hospital_table=ttk.Treeview(DataframeLeft,column=("nameoftablets","ref","dose","nooftablets","lot","issuedate",
                                                       "expdate","dailaydose","nhsnumber","pname","dob","address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.hospital_table.heading("lot", text="Let")
